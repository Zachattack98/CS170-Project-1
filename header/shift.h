...
class Shift {
    public:
        ...
        Node* Move_Up(Node* slide) {
              ...
              return tempMove; //return new data to up_child
        }
        ...
        Node* Move_Down(Node* slide) {
              ...
              return tempMove; //return new data to down_child
        }
        ...
        Node* Move_Left(Node* slide) {
              ...
              return tempMove; //return new data to left_child
        }
        ...
        Node* Move_Right(Node* slide) {
              ...
              return tempMove; //return new data to right_child
        }
};